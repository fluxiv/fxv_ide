            ...
            child: Column(
              ...
              children: <Widget> [
                const Text('Your Place\nto...',
                    style: TextStyle(fontWeight: FontWeight.w900,fontSize: 48,fontFamily: 'Heebo',height:0.9)),
                const Text('Talk',
                    style: TextStyle(fontWeight: FontWeight.w900,color: Color(0xff30AAD8),fontSize: 80,fontFamily: 'Heebo')),
                const SizedBox(
                  width: 320,
                    ...
                    children: [
                      Container(
                        ...
                        child: ElevatedButton(onPressed: () => {},
                          child: const Text('Sign In',style: TextStyle(color: Color(0xff30AAD8)),),
