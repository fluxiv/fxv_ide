...
import 'package:fxv_ide/src/modules/feed/widgets/feed_publish_modal.dart';
                  ...
                  onTap: () => {
                    showDialog(
                        ...
                        builder: (BuildContext context) =>
                            FeedPublishModal(userid: widget.userId))
                  },
          ...
          Row(
            children: [
              Padding(
                ...
                child:
                    IconButton(onPressed: () => {}, icon: Icon(Iconsax.image5)),
              ),
              Padding(
                padding: EdgeInsets.only(right: 8),
                child:
                    IconButton(onPressed: () => {}, icon: Icon(Iconsax.chart5)),
              ),
              Padding(
                padding: EdgeInsets.only(right: 8),
                child: IconButton(
                    onPressed: () => {}, icon: Icon(Iconsax.calendar5)),
              ),
            ],
          )
        ],
