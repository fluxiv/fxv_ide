          ...
          child: Column(
              ...
              children: [
                ...
                SizedBox(
                  width: 350.0,
                  child: Text(
                      "We prepare this easy interactive resume about our terms and services to you know what Fluxiv expects from you and what you can expect from us."),
                ),
                Container(
                  width: 350.0,
                  padding: EdgeInsets.only(top: 12),
                  child: Text(
                    "We don’t like the same boring “Blah, blah, blah” so we made it more enjoyable!  :)",
