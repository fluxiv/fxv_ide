...
import 'package:fxv_ide/src/environment/environment.dart';
...
//final String baseUrl = Environment().urlApi
  ...
  updateTerms(dynamic params) async {
    final queryParams = {"id": params["id"], "bool": params["bool"]};
  ...
  saveProfilePicture(String id, dynamic image, dynamic filename) async {
    ...
    req.files
        .add(http.MultipartFile.fromBytes('photo', image, filename: filename));
